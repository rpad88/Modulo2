    ...
    <>
      ...
      >
        ...
        <Modal.Footer className='d-flex'>
          <Button variant='danger' size='lg' style={{flexGrow: 1}} onClick={handleClose}>Fechar</Button>
          <Button variant='warning' size='lg' style={{flexGrow: 1}} onClick={() => alert('Item adicionado ao carrinho')}>Comprar</Button>
        </Modal.Footer>
      </Modal>
    </>
  );
